    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Text("Popular", style: GoogleFonts.montserrat(fontSize: 18, fontWeight: FontWeight.bold)),
            InkWell(onTap: () {
              Navigator.pushNamed(context, popularScreen);
        ...
        BlocBuilder<PopularCubit, PopularState>(
          builder: (context, state) {
            ...
            var data = (state as PopularLoaded).popular;
